...
# 转换函数：将一个对Tensor定义的函数转换成一个正常对Numpy定义的函数
def tffunc(*argtypes):
...
if __name__ == '__main__':
    ...
    render_lapnorm(layer_output[:, :, :, channel], img_noise, iter_n=50)
